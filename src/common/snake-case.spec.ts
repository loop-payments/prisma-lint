...
describe("toSnakeCase", () => {
  describe("cases", () => {
    it("converts single-word string to snake case", () => {
      const input = "hello";
      const result = getExpectedSnakeCase(input);
  ...
  describe("without prefix", () => {
    it("removes prefix", () => {
      ...
      const result = getExpectedSnakeCase(input, { trimPrefix: "Prefix" });
      expect(result).toEqual("word");
    });

    it("does not remove prefix if it does not match", () => {
      const input = "SomethingElsePrefixWord";
      const result = getExpectedSnakeCase(input, { trimPrefix: "Pre" });
